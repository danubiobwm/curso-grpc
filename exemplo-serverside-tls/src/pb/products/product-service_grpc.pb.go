...
type ProductServiceClient interface {
	FindAll(ctx context.Context, in *ListProductsRequest, opts ...grpc.CallOption) (*ListProductResponse, error)
}
...
func (c *productServiceClient) FindAll(ctx context.Context, in *ListProductsRequest, opts ...grpc.CallOption) (*ListProductResponse, error) {
...
type ProductServiceServer interface {
	FindAll(context.Context, *ListProductsRequest) (*ListProductResponse, error)
...
func (UnimplementedProductServiceServer) FindAll(context.Context, *ListProductsRequest) (*ListProductResponse, error) {
