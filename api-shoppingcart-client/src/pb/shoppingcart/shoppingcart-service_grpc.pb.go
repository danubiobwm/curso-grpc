...
type ShoppingCartServiceClient interface {
	AddItem(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[AddProduct, ShoppingCartTotal], error)
}
...
func (c *shoppingCartServiceClient) AddItem(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[AddProduct, ShoppingCartTotal], error) {
	...
	x := &grpc.GenericClientStream[AddProduct, ShoppingCartTotal]{ClientStream: stream}
	return x, nil
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type ShoppingCartService_AddItemClient = grpc.BidiStreamingClient[AddProduct, ShoppingCartTotal]
...
type ShoppingCartServiceServer interface {
	AddItem(grpc.BidiStreamingServer[AddProduct, ShoppingCartTotal]) error
...
func (UnimplementedShoppingCartServiceServer) AddItem(grpc.BidiStreamingServer[AddProduct, ShoppingCartTotal]) error {
	return status.Errorf(codes.Unimplemented, "method AddItem not implemented")
}
...
func _ShoppingCartService_AddItem_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(ShoppingCartServiceServer).AddItem(&grpc.GenericServerStream[AddProduct, ShoppingCartTotal]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type ShoppingCartService_AddItemServer = grpc.BidiStreamingServer[AddProduct, ShoppingCartTotal]
